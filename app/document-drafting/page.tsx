...
import { FileText, Download, Eye, Sparkles, Save, Loader2, BookTemplate as Template, Clock } from 'lucide-react';
...
export default function DocumentDrafting() {
  ...
  const [recentDocuments, setRecentDocuments] = useState<RecentDocType[]>([]);
